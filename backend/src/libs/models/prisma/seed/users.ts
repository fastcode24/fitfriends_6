...
export const mockUsers = [
  {
    ...
    avatar: 'mock-images/avatars/users/photo-1.png',
    background: 'mock-images/backgrounds/background.jpg',
  ...
  },
  {
    ...
    metro: getRandomEnumValue(Metro),
    avatar: 'mock-images/avatars/users/photo-2.png',
    background: 'mock-images/backgrounds/background.jpg',
    level: getRandomEnumValue(Level),
  ...
  },
  {
    ...
    metro: getRandomEnumValue(Metro),
    avatar: 'mock-images/avatars/users/photo-3.png',
    background: 'mock-images/backgrounds/background.jpg',
    level: getRandomEnumValue(Level),
  ...
  },
  {
    ...
    metro: getRandomEnumValue(Metro),
    avatar: 'mock-images/avatars/users/photo-4.png',
    background: 'mock-images/backgrounds/background.jpg',
    level: getRandomEnumValue(Level),
  ...
  },
  {
    ...
    metro: getRandomEnumValue(Metro),
    avatar: 'mock-images/avatars/coaches/photo-1.png',
    background: 'mock-images/backgrounds/background-coach.jpg',
    level: getRandomEnumValue(Level),
